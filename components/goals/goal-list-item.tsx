...
export function GoalListItem({ goal, colorIndex }: GoalListItemProps) {
  ...
  return (
    <li className="border-border hover:bg-foreground/5 border-b transition-colors last:border-b-0">
      <div className="flex items-center gap-4 px-(--card-spacing) py-4">
        <div
        ...
        <div className="hidden shrink-0 text-right sm:block">
          <p className="text-foreground font-semibold">{target.value}</p>
