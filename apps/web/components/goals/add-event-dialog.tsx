...
function getEventFormDescription(goal: Goal): ReactNode {
  ...
  return matchGoalType(goal.type, {
    OCCURANCE: () => <>How many times did you perform {goalName}?</>,
    TIME: () => <>How much time did you invest in {goalName}?</>,
    AMOUNT: () => <>How much did you perform {goalName}?</>,
  });
}
...
function canSubmitGoalEvent(
  ...
  return matchGoalType(goal.type, {
    OCCURANCE: () => isPositiveOccurrenceValue(occurrenceValue),
    TIME: () => isPositiveTimeValue(hoursValue, minutesValue),
    AMOUNT: () => isPositiveAmountValue(amountValue),
  });
}
